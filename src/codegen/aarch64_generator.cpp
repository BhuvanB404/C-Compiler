...
string Arm64Gen::gcode(const vector<inst>& ir)
{
    m_output.str("");
    m_output.clear();
...
string Arm64Gen::asm_cmd(const string& asm_file, const string& obj_file) const
{
    return "as -64 " + asm_file + " -o " + obj_file;
}

string Arm64Gen::ld_cmd(const string& obj_file, const string& exe_file) const
{
...
void Arm64Gen::metadata(const vector<inst>& ir)
{
    m_var_offsets.clear();
    m_externs.clear();
    m_stack_size = 0;
...
void Arm64Gen::ginstrs(const vector<inst>& ir)
{
    for (const auto& instr : ir)
    {
        ginstr(instr);
...
void Arm64Gen::ginstr(const inst& instr)
{
    switch (instr.kind)
    {
...
void Arm64Gen::emit(const string& code)
{
    m_output << code;
}

void Arm64Gen::larg(const Arg& arg, const string& reg)
{
    switch (arg.type)
    {
...
void Arm64Gen::gadd(const inst& instr)
{
...
void Arm64Gen::gsub(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
...
void Arm64Gen::gmul(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
...
void Arm64Gen::gdiv(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
...
void Arm64Gen::gmod(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
...
void Arm64Gen::geq(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
    m_output << "    cmp x0, x1\n";
...
void Arm64Gen::gne(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
    m_output << "    cmp x0, x1\n";
...
void Arm64Gen::glt(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
    m_output << "    cmp x0, x1\n";
...
void Arm64Gen::gle(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
    m_output << "    cmp x0, x1\n";
...
void Arm64Gen::ggt(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
    m_output << "    cmp x0, x1\n";
...
void Arm64Gen::gge(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
    m_output << "    cmp x0, x1\n";
...
void Arm64Gen::gand(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
    m_output << "    cmp x0, #0\n";
...
void Arm64Gen::gor(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
    m_output << "    cmp x0, #0\n";
...
void Arm64Gen::gshl(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
...
void Arm64Gen::gshr(const inst& instr)
{
    larg(instr.binop.left, "x0");
    larg(instr.binop.right, "x1");
...
//Todo: implement checker function to check if the target is available
bool Arm64Gen::avail() const
{
    return true;
}
